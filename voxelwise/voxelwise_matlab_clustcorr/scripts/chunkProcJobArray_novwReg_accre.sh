...
#SBATCH --mem=32G
#SBATCH --array=0-30
#SBATCH --output=/nobackup/h_vmac/user/robbwh/voxelwise/fdg_pet/pre_post/processingInR/logs/job_chunkProc__%A_%a_.out
...
#Mask img
maskImg="$processingInRDir"/explicit_mask.nii
...
#for SLURM_ARRAY_TASK_ID in `seq 0 30`; do
